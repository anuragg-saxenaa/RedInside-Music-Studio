...
- Name: mastering.spec.ts >> Mastering E2E >> upload zone exists in DOM (may be hidden)
- Location: tests/e2e/mastering.spec.ts:10:3
...
Locator: locator('[data-testid="upload-zone"]')
Expected: attached
Timeout: 5000ms
